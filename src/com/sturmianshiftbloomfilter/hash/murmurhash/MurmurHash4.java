...
*/
   ...
   public static int[] MurmurHash3_x64_32_4(final byte[] key, final int seed){
	   long[] hash = MurmurHash3_x64_128(key, seed);
	   int[] array1 = long2doubleInt(hash[0]);
	   int[] array2 = long2doubleInt(hash[1]);	   
