package com.sturmianshiftbloomfilter.hash.murmurhash;

import com.sturmianshiftbloomfilter.hash.g414.CWowHash;
...
public final class MurmurHash {
    ...
    public static int[] hash64_2(final byte[] data, final int length){
	   int[] array1 = long2doubleInt(MurmurHash.hash64(data, length, 0x75676));
	   int[] array2 = long2doubleInt(MurmurHash.hash64(data, length, 0x2342344));	   
